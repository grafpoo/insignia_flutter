...
class InsigniaLists {
  ...
  InsigniaLists() {
    ...
    // don't reuse current USx list as values can get modified
    addDedupedToList(allList, createUsnInsigniaList());
    addDedupedToList(allList, createUsafInsigniaList());
    addDedupedToList(allList, createUsmcInsigniaList());
    addDedupedToList(allList, createUscgInsigniaList());
    _insigniaLists[ALL] = allList;
  }

  void addDedupedToList(
      List<Insignia> allList, List<Insignia> newInsigniaList) {
  ...
  List<Insignia> createUsafInsigniaList() {
    return []
      ...
      ..add(Insignia(
          "USAF", "E-3", "Airman First Class", "C", "USAF_E3_OR3_AM1.png"))
      ..add(
          Insignia("USAF", "E-4", "Senior Airman", "C", "USAF_E4_OR4_SAM.png"))
      ..add(Insignia(
          "USAF", "E-5", "Staff Sergeant", "C", "USAF_E5_OR5_SSGT.png"))
      ..add(Insignia(
          "USAF", "E-6", "Technical Sergeant", "C", "USAF_E6_OR6_TSGT.png"))
      ..add(Insignia(
          "USAF", "E-7", "Master Sergeant", "C", "USAF_E7_OR7_MSGT.png"))
      ..add(Insignia("USAF", "E-8", "Senior Master Sergeant", "C",
          "USAF_E8_OR8_SMSGT.png"))
      ..add(Insignia(
          "USAF", "E-9", "Chief Master Sergeant", "C", "USAF_E9_OR9_CMSGT.png"))
      ..add(Insignia("USAF", "E-9", "Command Chief Master Sergeant", "C",
          "USAF_E9_OR9_CCMS.png"))
      ..add(Insignia("USAF", "E-9", "Chief Master Sergeant of the Air Force",
          "C", "USAF_E9_OR9_CMSAF.png"))
      ...
      ..add(Insignia(
          "USAF", "O-11", "General of the Air Force", "C", "US_O11.png"));
  }
  ...
  List<Insignia> createUsaInsigniaList() {
    return []
      ...
      ..add(Insignia(
          "USA", "E-2", "Private Second Class", "C", "USA_E2_OR2_PV2.png"))
      ..add(Insignia(
          "USA", "E-3", "Private First Class", "C", "USA_E3_OR3_PFC.png"))
      ...
      ..add(Insignia(
          "USA", "E-7", "Sergeant First Class", "C", "USA_E7_OR7_SFC.png"))
      ...
      ..add(Insignia(
          "USA", "E-9", "Command Sergeant Major", "C", "USA_E9_OR9_CSM.png"))
      ..add(Insignia("USA", "E-9", "Sergeant Major of the Army", "C",
          "USA_E9_OR9_SMA.png"))
      ..add(Insignia("USA", "W-1", "Warrant Officer 1", "C", "USA_W1_CW1.png"))
      ..add(Insignia(
          "USA", "W-2", "Chief Warrant Officer 2", "C", "USA_W2_CW2.png"))
      ..add(Insignia(
          "USA", "W-3", "Chief Warrant Officer 3", "C", "USA_W3_CW3.png"))
      ..add(Insignia(
          "USA", "W-4", "Chief Warrant Officer 4", "C", "USA_W4_CW4.png"))
      ..add(Insignia(
          "USA", "W-5", "Chief Warrant Officer 5", "C", "USA_W5_CW5.png"))
  ...
  List<Insignia> createUsmcInsigniaList() {
    return []
      ...
      ..add(Insignia(
          "USMC", "E-2", "Private First Class", "C", "USMC_E2_PFC.png"))
      ...
      ..add(
          Insignia("USMC", "E-7", "Gunnery Sergeant", "C", "USMC_E7_GSGT.png"))
      ..add(Insignia("USMC", "E-8", "First Sergeant", "C", "USMC_E8_1SG.png"))
      ..add(Insignia("USMC", "E-8", "Master Sergeant", "C", "USMC_E8_MSGT.png"))
      ..add(Insignia(
          "USMC", "E-9", "Master Gunnery Sergeant", "C", "USMC_E9_MGSGT.png"))
      ..add(Insignia("USMC", "E-9", "Sergeant Major", "C", "USMC_E9_SM.png"))
      ..add(Insignia("USMC", "E-9", "Sergeant Major of the Marine Corps", "C",
          "USMC_E9_SMMC.png"))
      ..add(
          Insignia("USMC", "W-1", "Warrant Officer 1", "C", "USMC_W1_WO1.png"))
      ..add(Insignia(
          "USMC", "W-2", "Chief Warrant Officer 2", "C", "USMC_W2_CWO2.png"))
      ..add(Insignia(
          "USMC", "W-3", "Chief Warrant Officer 3", "C", "USMC_W3_CWO3.png"))
      ..add(Insignia(
          "USMC", "W-4", "Chief Warrant Officer 4", "C", "USMC_W4_CWO4.png"))
      ..add(Insignia(
          "USMC", "W-5", "Chief Warrant Officer 5", "C", "USMC_W5_CWO5.png"))
  ...
  List<Insignia> createUsnInsigniaList() {
    return []
      ...
      ..add(Insignia(
          "USN", "E-2", "Seaman Apprentice", "C", "USN_E2_SA_collar.png"))
      ...
      ..add(Insignia(
          "USN", "E-2", "Constructionman Apprentice", "C", "USCG_E2_CA.png"))
      ...
      ..add(Insignia(
          "USN", "E-4", "Petty Officer Third Class", "C", "USN_E4_PO3.png"))
      ..add(Insignia(
          "USN", "E-5", "Petty Officer Second Class", "C", "USN_E5_PO2.png"))
      ..add(Insignia(
          "USN", "E-6", "Petty Officer First Class", "C", "USN_E6_PO1.png"))
      ..add(
          Insignia("USN", "E-7", "Chief Petty Officer", "C", "USN_E7_CPO.png"))
      ..add(Insignia(
          "USN", "E-8", "Senior Chief Petty Officer", "C", "USN_E8_SCPO.png"))
      ..add(Insignia("USN", "E-8", "Command Senior Chief Petty Officer", "C",
          "USN_E8_CMDCS.png"))
      ..add(Insignia(
          "USN", "E-9", "Master Chief Petty Officer", "C", "USN_E9_MCPO.png"))
      ..add(Insignia("USN", "E-9", "Command Master Chief Petty Officer", "C",
          "USN_E9_CMCPO.png"))
      ..add(Insignia("USN", "E-9", "Fleet Master Chief Petty Officer", "C",
          "USN_E9_FMCPO.png"))
      ..add(Insignia("USN", "E-9", "Master Chief Petty Officer of the Navy",
          "C", "USN_E9_MCPON.png"))
      ..add(Insignia("USN", "W-1", "Warrant Officer One", "C", "US_W1_WO1.png"))
      ..add(Insignia(
          "USN", "W-1", "Warrant Officer One", "S", "USN_W1_WO1_s.png"))
      ..add(Insignia(
          "USN", "W-2", "Chief Warrant Officer Two", "C", "US_W2_CW2.png"))
      ..add(Insignia(
          "USN", "W-2", "Chief Warrant Officer Two", "S", "USN_W2_CW2_s.png"))
      ..add(Insignia(
          "USN", "W-3", "Chief Warrant Officer Three", "C", "US_W3_CW3.png"))
      ..add(Insignia(
          "USN", "W-3", "Chief Warrant Officer Three", "S", "USN_W3_CW3_s.png"))
      ..add(Insignia(
          "USN", "W-4", "Chief Warrant Officer Four", "S", "USN_W4_CW4_s.png"))
      ..add(Insignia(
          "USN", "W-5", "Chief Warrant Officer Five", "C", "US_W5_CW5.png"))
      ..add(Insignia(
          "USN", "W-5", "Chief Warrant Officer Five", "S", "USN_W5_CW5_s.png"))
      ..add(Insignia("USN", "Student", "", "Midshipman/Officer CandidatE-S",
          "USN_SO_OC_s.png"))
      ..add(Insignia("USN", "O-1", "Ensign", "C", "US_O1.png"))
      ..add(Insignia("USN", "O-1", "Ensign", "S", "USN_O1_s.png"))
      ..add(
          Insignia("USN", "O-2", "Lieutenant (Junior Grade)", "C", "US_O2.png"))
      ..add(Insignia(
          "USN", "O-2", "Lieutenant (Junior Grade)", "S", "USN_O2_s.png"))
      ...
      ..add(
          Insignia("USN", "O-7", "Rear Admiral (lower half)", "C", "US_O7.png"))
      ..add(Insignia(
          "USN", "O-7", "Rear Admiral (lower half)", "S", "USN_O7_s.png"))
      ...
      ..add(
          Insignia("USN", "SG", "Admiral of the Navy", "S", "USN_SG_AN_s.png"));
  }
  ...
  List<Insignia> createUscgInsigniaList() {
    return []
      ...
      ..add(Insignia(
          "USCG", "E-2", "Seaman Apprentice", "C", "USN_E2_SA_collar.png"))
      ..add(Insignia("USCG", "E-2", "Seaman Apprentice", "C", "USN_E2_SA.png"))
      ..add(
          Insignia("USCG", "E-2", "Fireman Apprentice", "C", "USCG_E2_FA.png"))
      ..add(Insignia("USCG", "E-2", "Airman Apprentice", "C", "USCG_E2_AA.png"))
      ..add(Insignia(
          "USCG", "E-2", "Constructionman Apprentice", "C", "USCG_E2_CA.png"))
      ...
      ..add(Insignia(
          "USCG", "E-4", "Petty Officer Third Class", "C", "USCG_E4_PO3.png"))
      ..add(Insignia(
          "USCG", "E-5", "Petty Officer Second Class", "C", "USCG_E5_PO2.png"))
      ..add(Insignia(
          "USCG", "E-6", "Petty Officer First Class", "C", "USCG_E6_PO1.png"))
      ..add(Insignia(
          "USCG", "E-7", "Chief Petty Officer", "C", "USCG_E7_CPO.png"))
      ..add(Insignia(
          "USCG", "E-8", "Senior Chief Petty Officer", "C", "USCG_E8_SCPO.png"))
      ..add(Insignia(
          "USCG", "E-9", "Master Chief Petty Officer", "C", "USCG_E9_MCPO.png"))
      ..add(Insignia("USCG", "E-9", "Command Master Chief Petty Officer", "C",
          "USCG_E9_MCPO.png"))
      ..add(Insignia(
          "USCG",
          "E-9",
      ...
      ..add(Insignia(
          ...
          "USCG_E9_MCPOCG.png"))
      ..add(Insignia(
          "USCG", "W-2", "Chief Warrant Officer Two", "C", "US_W2_CW2.png"))
      ..add(Insignia(
          "USCG", "W-2", "Chief Warrant Officer Two", "S", "USCG_W2_CW2_s.png"))
      ..add(Insignia(
          "USCG", "W-3", "Chief Warrant Officer Three", "C", "US_W3_CW3.png"))
      ..add(Insignia("USCG", "W-3", "Chief Warrant Officer Three", "S",
          "USCG_W3_CW3_s.png"))
      ..add(Insignia(
          "USCG", "W-4", "Chief Warrant Officer Four", "C", "US_W4_CW4.png"))
      ..add(Insignia("USCG", "W-4", "Chief Warrant Officer Four", "S",
          "USCG_W4_CW4_s.png"))
      ..add(Insignia("USCG", "O-1", "Ensign", "C", "US_O1.png"))
      ..add(Insignia("USCG", "O-1", "Ensign", "S", "USCG_O1_s.png"))
      ..add(Insignia(
          "USCG", "O-2", "Lieutenant (Junior Grade)", "C", "US_O2.png"))
      ..add(Insignia(
          "USCG", "O-2", "Lieutenant (Junior Grade)", "S", "USCG_O2_s.png"))
      ...
      ..add(
          Insignia("USCG", "O-4", "Lieutenant Commander", "S", "USCG_O4_s.png"))
      ...
      ..add(Insignia(
          "USCG", "O-7", "Rear Admiral (lower half)", "C", "US_O7.png"))
      ..add(Insignia(
          "USCG", "O-7", "Rear Admiral (lower half)", "S", "USCG_O7_s.png"))
